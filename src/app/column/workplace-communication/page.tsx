        ...
        <NotebookLayout className="flex flex-col space-y-8 pb-20">
            <article className="bg-white/90 p-6 sm:p-8 rounded-lg notebook-border shadow-lg">
                ...
                <div className="space-y-6 text-gray-800 leading-relaxed font-medium">
                    ...
                    <p>
                        「で、結論は何？」とよく言われる場合、上司は「結論を急ぐ主導型（D）」や「事実を優先する論理型（C）」のスタイルを持っている可能性が高いです。
                    </p>
                    <div className="bg-blue-50 p-4 border border-blue-200 rounded">
                        <strong className="text-blue-800 block mb-2">💡 改善テクニック</strong>
                        <p className="text-sm">
                            プロセスや感情的な背景から話し始めるのではなく、「本日の報告事項は◯点で、結論は〜です」と端的に（C: 論理型のスタイルで）伝えましょう。
                        </p>
                    </div>
                    ...
                    <p>
                        会議中ずっと黙っているからといって、意見がないとは限りません。「一度自分の中で咀嚼してから発言する熟考型（S）」の人は、その場で振られてもすぐに言葉が出ないことが多いのです。
                    </p>
                    ...
                    <p>
                        プロジェクトが佳境に入ると、業務遂行に特化したD（主導型）やC（論理型）が強くなりすぎ、R（受容型）やE（共感型）のメンバーが委縮しがちです。
                    </p>
                    <div className="bg-pink-50 p-4 border border-pink-200 rounded">
                        <strong className="text-pink-800 block mb-2">💡 改善テクニック</strong>
                        <p className="text-sm">
                            雑談の時間を意図的に設けたり、「ありがとう」の感謝を言葉やスタンプで（E: 共感を込めて）伝える仕組みを取り入れましょう。論理や効率だけではない「温度感」が、チーム全体を機能させる潤滑油になります。
                        </p>
                    </div>
