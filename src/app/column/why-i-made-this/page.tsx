        ...
        <NotebookLayout className="flex flex-col space-y-8 pb-20">
            <article className="bg-white/90 p-6 sm:p-8 rounded-lg notebook-border shadow-lg">
                ...
                <div className="space-y-6 text-gray-800 leading-relaxed font-medium">
                    ...
                    <p>
                        当時の私は、IT・メーカー・人材と業界を絞らず、ベンチャーから大手まで広く見ていました。当然、面接で会う人のタイプもばらばらです。結論から詰めてくる人もいれば、雑談から入ってじっくり温度を上げていく人もいる。同じ話をしているのに、相手によって手ごたえがまったく違うということを、あの時期に何度も経験しました。
                    </p>
                    <p>
                        今にして思えば、あれは「相手の会話スタイルが違った」というだけの話です。でも当時の私にはその言葉がなかったので、うまくいかなかった面接のあとは、つい自分のせいにしていました。
                    </p>
                    <p>
