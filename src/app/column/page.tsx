...
const COLUMNS = [
    ...
    },
    {
        ...
        description: "診断を受けて終わりにしないための実践編。自分の当たり前を疑い、相手の言動をスタイルに翻訳し、受け取りやすいボールを投げる。具体的な会話例つきで解説します。",
        emoji: "🤝",
    },
    {
        slug: "workplace-communication",
        title: "職場のすれ違いを4軸で解く — 報連相・会議・空気の重さ",
        description: "「で、結論は？」と言われる。会議で誰も発言しない。空気が重い。職場のよくある4場面を、会話スタイルの違いから言い換え例つきで解きほぐします。",
        emoji: "🏢",
    },
    {
