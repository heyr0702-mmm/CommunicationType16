        ...
        <NotebookLayout className="flex flex-col space-y-8 pb-20">
            <article className="bg-white/90 p-6 sm:p-8 rounded-lg notebook-border shadow-lg">
                ...
                <div className="space-y-6 text-gray-800 leading-relaxed font-medium">
                    ...
                    <p>
                        自分にとって居心地の良い会話のテンポや熱量は、他の人にとっては苦痛かもしれません。例えば、言葉をたくさん交わすことで安心感を得る人（X: 表現型）と、必要最小限の言葉でノイズを減らしたい人（Z: 聞き役型）では、「無言」に対する感じ方が真逆です。
                    </p>
                    <p>
                    ...
                    <p>
                        「冷たい態度を取られた」と感じたとき、実は相手は「論理型（C）」に事実を述べているだけかもしれません。「ズカズカ踏み込んでくる」と感じた相手も、ただ「表現型（X）」で親愛を示しているだけかもしれません。
                    </p>
                    <div className="bg-gray-50 p-4 border border-gray-200 rounded">
                        <ul className="list-disc pl-5 space-y-2 text-sm">
                            <li><strong>冷たい</strong> → 感情より論理を優先するスタイルかも？（C）</li>
                            <li><strong>強引</strong> → 結論を急ぐ主導型のスタイルかも？（D）</li>
                            <li><strong>ノリが悪い</strong> → じっくり考える熟考型のスタイルかも？（S）</li>
                        </ul>
                    </div>
                    ...
                    <p>
                        相手のスタイルが掴めてきたら、少しだけ相手の周波数に合わせてみましょう。相手が論理を重んじるC（論理型）なら、こちらも「感情的な前置き」を減らして結論から話してみる。相手が共感を求めるE（共感型）なら、「そうだね」と同調する時間を多く取る。
                    </p>
                    <p>
