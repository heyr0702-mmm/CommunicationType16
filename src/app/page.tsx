      ...
      <section className="flex flex-col items-center justify-center text-center space-y-8 sm:space-y-12 min-h-[80vh] py-10">
        ...
        <div className="space-y-6 z-10 relative w-full max-w-xl px-2">
          ...
          <div className="text-center relative pt-6">
            <span className="absolute right-2 top-0 bg-neon-pink text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-md z-20">
              New!
            </span>

            <h1 className="text-[clamp(1.75rem,7vw,3rem)] font-bold tracking-tighter font-handwriting text-ink leading-tight text-center">
