...
export default function DiagnosisClient({ children }: { children?: React.ReactNode }) {
    ...
    return (
        <NotebookLayout className="flex flex-col max-w-2xl mx-auto py-4">
            {/* 設問エリア（初回表示で画面いっぱいを占め、解説はスクロール下に置く） */}
